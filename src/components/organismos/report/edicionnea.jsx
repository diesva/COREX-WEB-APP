...
function EdicionNeasList() {
  ...
  const handlePasswordSubmit = () => {
    const correctPassword = import.meta.env.VITE_APP_PASSWORD_2;
    ...
    if (!correctPassword) {
      setPasswordError("Error: La contraseña no está configurada en el servidor. Contacta al administrador.");
      return;
    }
